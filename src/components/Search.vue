  ...
  <div class="search-bar">
    ...
    <div class="search-input-wrapper">
      <input
        v-model="query"
        type="text"
        placeholder="Enter a location (eg. Amsterdam)"
        :disabled="store.loading"
        @keyup.enter="handleSearch"
      />
      <button :disabled="store.loading || !query.trim()" @click="handleSearch">
...
<style scoped>
.search-bar { padding: 24px 20px 16px; }
.search-title { font-size: 20px; font-weight: 700; margin: 0 0 16px; color: #1a1a2e; }
...
.error { margin-top: 8px; font-size: 13px; color: #ef4444; }
.info { margin-top: 8px; font-size: 13px; color: #6b7280; }
.loader {
